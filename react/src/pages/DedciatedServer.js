        ...
        <Layout>
                ...
                <div className="lg:container mx-auto px-4">
                    <div className='grid md:grid-cols-2 max-md:grid-cols-1 gap-[30px] items-center'>
                        <div className='md:text-left text-center'>
                            ...
                            <h1 className='font-bold text-[#000] md:mb-[15px] max-md:mb-[10px]'>Dedicated Bare Metal Server</h1>
                            <p className='text-[#000] md:text-[18px] text-[17px] md:mb-[30px] max-md:mb-[20px]'>Bare metal servers are the cloud services in which a physical machine is being rented by the user from a bare metal server provider and this machine is not being shared with others.</p>
            ...
            <section className="md:pb-[70px] max-md:pb-[50px]">
                <div className="lg:container mx-auto px-4">
                    ...
                    <div className='grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 max-md:grid-cols-1 gap-[15px]'>
...
export default DedciatedServer
