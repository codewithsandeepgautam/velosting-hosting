...
const RegisterModal = require('../schemas/register.schema')

const registerController = asyncHandler(async (req, res) => {
    const { name, email, service, countryCode, phone, companyName, websiteUrl } = req.body;
    if (!name || !email || !countryCode || !phone || !service || !companyName || !websiteUrl) {
                                     ...
                                     <td style="border:none;background-color: #00a51a0d;padding: 20px;border-radius: 5px;">
                                         <table width="100%" cellpadding="0" cellspacing="0" style="border:none;">
                                             <tbody>
                                                 ...
                                                 <tr style="border:none;color: #000;width: 100%;vertical-align: top;">
                                                     <th width="30%" style="color: #000;font-family: 'Open Sans', Arial, sans-serif;font-size:16px;line-height:23px;border:none;padding: 5px;text-align: left;">Company Name:</th>
                                                     <td width="70%" style="color: #000;font-family: 'Open Sans', Arial, sans-serif;font-size:16px;line-height:23px;border:none;padding: 5px;text-align: left;">${companyName}</td>
                                                 </tr>
                                                  <tr style="border:none;color: #000;width: 100%;vertical-align: top;">
                                                     <th width="30%" style="color: #000;font-family: 'Open Sans', Arial, sans-serif;font-size:16px;line-height:23px;border:none;padding: 5px;text-align: left;">Website-Url:</th>
                                                     <td width="70%" style="color: #000;font-family: 'Open Sans', Arial, sans-serif;font-size:16px;line-height:23px;border:none;padding: 5px;text-align: left;">${websiteUrl}</td>
                                                 </tr>
                                                 <tr style="border:none;color: #000;width: 100%;vertical-align: top;">
                                                     <th width="30%" style="color: #000;font-family: 'Open Sans', Arial, sans-serif;font-size:16px;line-height:23px;border:none;padding: 5px;text-align: left;">Service:</th>
                                                     <td width="70%" style="color: #000;font-family: 'Open Sans', Arial, sans-serif;font-size:16px;line-height:23px;border:none;padding: 5px;text-align: left;">${service}</td>
                                                 </tr>
                                             </tbody>
                                         </table>
                                     </td>
    ...
    try {
        ...
        const mailOptions = {
            ...
            subject: `Velosting | Register Form`,
            html: emailTemp
        };
        const status = await transporter.sendMail(mailOptions)
        if (status) {
            const newContact = await RegisterModal.create({
                name: name,
                email: email,
